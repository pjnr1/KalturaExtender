...
class KalturaReachProfile(KalturaObjectBase):
    def __init__(self,
            ...
            defaultSourceLanguage=NotImplemented,
    ...
    PROPERTY_LOADERS = {
        ...
        'defaultSourceLanguage': (KalturaEnumsFactory.createString, "KalturaCatalogItemLanguage"), 
    ...
    def toParams(self):
        ...
        kparams.addStringEnumIfDefined("defaultSourceLanguage", self.defaultSourceLanguage)
    ...
    def getDefaultSourceLanguage(self):
        return self.defaultSourceLanguage

    def setDefaultSourceLanguage(self, newDefaultSourceLanguage):
        self.defaultSourceLanguage = newDefaultSourceLanguage
...
class KalturaVendorCatalogItemPricing(KalturaObjectBase):
    ...
    def toParams(self):
        ...
        kparams.addIntIfDefined("pricePerUnit", self.pricePerUnit)
...
class KalturaVendorCredit(KalturaBaseVendorCredit):
    ...
    PROPERTY_LOADERS = {
        'credit': getXmlNodeInt, 
        'fromDate': getXmlNodeInt, 
        'allowOverage': (KalturaEnumsFactory.createInt, "KalturaNullableBoolean"), 
    ...
    def toParams(self):
        ...
        kparams.addIntIfDefined("fromDate", self.fromDate)
        kparams.addIntEnumIfDefined("allowOverage", self.allowOverage)
    ...
    def getAllowOverage(self):
        return self.allowOverage

    def setAllowOverage(self, newAllowOverage):
        self.allowOverage = newAllowOverage
...
class KalturaReachProfileService(KalturaServiceBase):
    ...
    def resetCredit(self, reachProfileId):
        """reset vednor profile credit"""

        kparams = KalturaParams()
        kparams.addIntIfDefined("reachProfileId", reachProfileId);
        self.client.queueServiceActionCall("reach_reachprofile", "resetCredit", "KalturaReachProfile", kparams)
        if self.client.isMultiRequest():
            return self.client.getMultiRequestResult()
        resultNode = self.client.doQueue()
        return KalturaObjectFactory.create(resultNode, 'KalturaReachProfile')
...
class KalturaEntryVendorTaskService(KalturaServiceBase):
    ...
    def approve(self, id):
        ...
        kparams = KalturaParams()
        kparams.addIntIfDefined("id", id);
        self.client.queueServiceActionCall("reach_entryvendortask", "approve", "None", kparams)
        if self.client.isMultiRequest():
            return self.client.getMultiRequestResult()
        resultNode = self.client.doQueue()
    ...
    def reject(self, id):
        ...
        kparams = KalturaParams()
        kparams.addIntIfDefined("id", id);
        self.client.queueServiceActionCall("reach_entryvendortask", "reject", "None", kparams)
        if self.client.isMultiRequest():
            return self.client.getMultiRequestResult()
        resultNode = self.client.doQueue()
    ...
    def update(self, id, entryVendorTask):
        ...
        kparams.addIntIfDefined("id", id);
        kparams.addObjectIfDefined("entryVendorTask", entryVendorTask)
        self.client.queueServiceActionCall("reach_entryvendortask", "update", "None", kparams)
        if self.client.isMultiRequest():
            return self.client.getMultiRequestResult()
        resultNode = self.client.doQueue()
